...
@section('content')
    ...
    <header class="intro-header" style="background-image: url('public/blog/img/home-bg.jpg')">
        <div class="container">
            <div class="row">
            ...
            <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                @foreach ($posts as $post)
                    ...
                    <div class="post-preview">
                        <a href="{{$a_post}}">
                            <div class="post-header-preview" style="background-image: url('public/{{$post['header_image']}}')"></div>
                        </a>
                        <a href="{{$a_post}}">
                            <h2 class="post-title">
                                {{$post['title']}}
